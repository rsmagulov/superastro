...
-- Overrides from debug shortest used blocks (topic_category=purpose_path)

-- Source JSON: C:/Projects/superastro/debug_purpose_path_ru_160_20260223_144242_mini_topiccore.json

-- Filter: len(text)<= 700, max_keys=400

BEGIN;

UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.planet.pluto): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.planet.pluto' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.planet.pluto', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.planet.pluto): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.purpose_path.generic): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.purpose_path.generic' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.purpose_path.generic', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.purpose_path.generic): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.purpose_path.generic' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.cusp.sign.any): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.cusp.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.cusp.sign.any', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.cusp.sign.any): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.cusp.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.ruler.jupiter): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.ruler.jupiter' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.ruler.jupiter', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.ruler.jupiter): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.ruler.jupiter' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.cusp.sign.sagittarius): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.cusp.sign.sagittarius' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.cusp.sign.sagittarius', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.cusp.sign.sagittarius): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.cusp.sign.sagittarius' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.ruler.jupiter.sign.any): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.ruler.jupiter.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.ruler.jupiter.sign.any', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.ruler.jupiter.sign.any): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.ruler.jupiter.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.elements.dominant.fire' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.elements.dominant.fire', 'purpose_path', 'ru-RU', 'Доминирует стихия Огонь: она чаще всего ведёт тебя к решениям. Сильная сторона — быстро включаешься в «родной» стиль. Риск — недооценивать противоположные подходы. Практика: добавь один компенсирующий шаг из другой стихии (план/контакт/чувства/действие) перед финальным выбором.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.elements.dominant.fire' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.modality.dominant.fixed' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.modality.dominant.fixed', 'purpose_path', 'ru-RU', 'Доминирует модальность фиксированная: сильные стороны — устойчивость, доведение до результата, верность выбранному. Риски — застревание, сопротивление переменам. Практика: выбери один процесс, где нужен баланс, и добавь недостающую стадию (старт/стабилизация/адаптация) на неделю.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.modality.dominant.fixed' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.ruler.jupiter.aspects.present): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.ruler.jupiter.aspects.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.ruler.jupiter.aspects.present', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.ruler.jupiter.aspects.present): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.ruler.jupiter.aspects.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.elements.deficient.water' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.elements.deficient.water', 'purpose_path', 'ru-RU', 'Дефицит стихии Вода: этот способ реагирования может требовать сознательной тренировки. Не слабость, а зона развития: её легче встроить через простые ритуалы. Практика: выбери 1 привычку на 10 минут в день, которая добавляет {er} (например: телесная рутина, общение, эмоции, действие).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.elements.deficient.water' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Натальный маркер (natal.house.9.ruler.jupiter.aspect.sextile.mars): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.ruler.jupiter.aspect.sextile.mars' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.ruler.jupiter.aspect.sextile.mars', 'purpose_path', 'ru-RU', 'Натальный маркер (natal.house.9.ruler.jupiter.aspect.sextile.mars): это подсказка о стиле реакции и типичных сценариях. Практика: отследи, как это проявляется 7 дней (триггеры → реакция → результат) и выбери одну настройку поведения (границы, темп, коммуникация, режим восстановления).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.ruler.jupiter.aspect.sextile.mars' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.elements.earth.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.elements.earth.count.3', 'purpose_path', 'ru-RU', 'Стихия Земля выражена на уровне 3. Это задаёт привычный способ включаться в жизнь: через смысл/действие (Огонь), практику/материальность (Земля), идеи/контакты (Воздух), чувства/интуицию (Вода). Практика: в сложной ситуации попробуй «перевести» задачу на язык этой стихии и посмотри, что упростится.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.elements.earth.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.elements.fire.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.elements.fire.count.3', 'purpose_path', 'ru-RU', 'Стихия Огонь выражена на уровне 3. Это задаёт привычный способ включаться в жизнь: через смысл/действие (Огонь), практику/материальность (Земля), идеи/контакты (Воздух), чувства/интуицию (Вода). Практика: в сложной ситуации попробуй «перевести» задачу на язык этой стихии и посмотри, что упростится.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.elements.fire.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.elements.air.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.elements.air.count.3', 'purpose_path', 'ru-RU', 'Стихия Воздух выражена на уровне 3. Это задаёт привычный способ включаться в жизнь: через смысл/действие (Огонь), практику/материальность (Земля), идеи/контакты (Воздух), чувства/интуицию (Вода). Практика: в сложной ситуации попробуй «перевести» задачу на язык этой стихии и посмотри, что упростится.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.elements.air.count.3' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Куспид 10 дома показывает стиль достижения: как ты поднимаешь статус и за счёт чего закрепляешь результат. Он описывает «манеру успеха»: через дисциплину, харизму, пользу, связи или смысл. Практика: опиши свой рабочий стиль в 2 фразы и проверь, какие задачи усиливают репутацию, а какие её размывают.', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.10.cusp.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.cusp.sign.any', 'purpose_path', 'ru-RU', 'Куспид 10 дома показывает стиль достижения: как ты поднимаешь статус и за счёт чего закрепляешь результат. Он описывает «манеру успеха»: через дисциплину, харизму, пользу, связи или смысл. Практика: опиши свой рабочий стиль в 2 фразы и проверь, какие задачи усиливают репутацию, а какие её размывают.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.cusp.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.ruler.jupiter.aspect.sextile.mars' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.ruler.jupiter.aspect.sextile.mars', 'purpose_path', 'ru-RU', 'Управитель 10 дома (Юпитер) в аспекте секстиль с Марс: это влияет на карьерные решения и стиль достижения. Обычно это даёт ресурс и проще превращается в навык/результат. Практика: опиши 1 повторяющийся карьерный сценарий (триггер → реакция → результат) и добавь одно правило, которое стабилизирует итог.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.ruler.jupiter.aspect.sextile.mars' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.cancer.present', 'purpose_path', 'ru-RU', 'Рак заметно проявлен в карте. Сильные стороны: эмпатия, забота, интуиция, память. Риски перекоса: ранимость, обидчивость, уход в защиту. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.cancer.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.ruler.any', 'purpose_path', 'ru-RU', 'Управитель 10 дома — ключ к карьерной траектории: через какие мотивы и навыки ты выходишь на статус и признание. Он показывает, что укрепляет репутацию и какие условия делают рост стабильным. Практика: найди 1 повторяющийся карьерный сценарий (успех/ошибка) и выдели правило, которое ты готов(а) соблюдать всегда.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.ruler.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.gemini.present', 'purpose_path', 'ru-RU', 'Близнецы заметно проявлен в карте. Сильные стороны: гибкость ума, коммуникации, обучение. Риски перекоса: распыление, поверхностность, нервозность. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.gemini.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.taurus.present', 'purpose_path', 'ru-RU', 'Телец заметно проявлен в карте. Сильные стороны: устойчивость, практичность, вкус и качество. Риски перекоса: инертность, упрямство, страх перемен. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.taurus.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.leo.present', 'purpose_path', 'ru-RU', 'Лев заметно проявлен в карте. Сильные стороны: самовыражение, лидерство, творчество. Риски перекоса: самолюбие, драматизация, зависимость от оценки. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.leo.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.ruler.jupiter.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.ruler.jupiter.sign.any', 'purpose_path', 'ru-RU', 'Юпитер как управитель 10 дома: стиль карьеры зависит от того, в каком «режиме» проявляется Юпитер (знак/аспекты). Сильная сторона — можно точнее настроить позиционирование и рабочий стиль. Практика: перед важной задачей выбери 1 настройку поведения (структура/темп/диалог/видимость) и удерживай её до сдачи результата.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.ruler.jupiter.sign.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.scorpio.present', 'purpose_path', 'ru-RU', 'Скорпион заметно проявлен в карте. Сильные стороны: глубина, стойкость, концентрация, трансформация. Риски перекоса: контроль, подозрительность, крайности. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.scorpio.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.sign.aquarius.present', 'purpose_path', 'ru-RU', 'Водолей заметно проявлен в карте. Сильные стороны: независимость, инновации, идеи, команда. Риски перекоса: отстранённость, упрямство идей, непредсказуемость. Практика: выбери 1 сильную сторону и 1 риск и закрепи их в конкретном действии на неделю (что усиливаю, что ограничиваю, по каким признакам пойму, что баланс соблюдён).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.sign.aquarius.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.angle.mc', 'purpose_path', 'ru-RU', 'MC (Середина Неба) — вектор карьеры и общественного образа: как ты хочешь быть видим(а) и за что тебя ценят «снаружи». Он связан с направлением роста, статусом и типом задач, где проще получать признание. Практика: сформулируй 1 фразу «за что я хочу быть известен(на)» и проверь, какие действия реально поддерживают её каждую неделю.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.angle.mc' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.ruler.jupiter' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.ruler.jupiter', 'purpose_path', 'ru-RU', 'Управитель 10 дома — Юпитер: карьерный рост лучше идёт через масштаб, наставничество, репутация. Сильная сторона — можно сознательно развивать эту функцию как главный рычаг. Риск — перегибать роль (например, давить, спасать, слишком контролировать). Практика: выбери 1 навык по этой планете и прокачай его 14 дней с измеримой метрикой.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.ruler.jupiter' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.ruler.jupiter.aspects.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.ruler.jupiter.aspects.present', 'purpose_path', 'ru-RU', 'Аспекты управителя 10 дома (Юпитер) показывают, что усиливает или усложняет карьерную реализацию. Гармоничные аспекты дают естественный ресурс, напряжённые требуют стратегии и навыка управления рисками. Практика: выбери 1 стрессовую точку (дедлайн/конфликт/неясные ожидания) и заранее задай правило, как ты действуешь в таких ситуациях.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.ruler.jupiter.aspects.present' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.cusp.sign.sagittarius' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.cusp.sign.sagittarius', 'purpose_path', 'ru-RU', 'Куспид 10 дома в Стрелец: способ добиваться статуса и результата идёт через качества Стрелец. Сильная сторона: широта взглядов, смысл, честность, рост. Риск: прямолинейность, обещания без расчёта, беспокойство. Практика: выбери 1 привычку «по знаку» и закрепи её как рабочий стандарт (как принимаю решения, как сдаю результат, как общаюсь).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.cusp.sign.sagittarius' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.polarity.balance.yang' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.polarity.balance.yang', 'purpose_path', 'ru-RU', 'Баланс полярности смещён в Ян: легче включаться в действие, проявлять инициативу и брать роль. Риск — идти вперёд без пауз и не слышать сигналов усталости/отношений. Микро-пример: в дедлайне можно ускориться так, что качество и диалог проседают. Практика: добавь «стоп-проверку» перед решениями (пауза 60 секунд: цель, последствия, ресурс).', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.polarity.balance.yang' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
UPDATE knowledge_items
SET text = 'Управитель 9 дома — ключ к смыслу, мировоззрению и траектории роста: через что ты расширяешь горизонты и находишь направление. Он показывает, что делает обучение/путешествия/идею продуктивными, а что уводит в теорию без шага в реальность. Практика: выбери 1 «линию роста» на 14 дней (курс/чтение/проект/наставник) и закрепи её ежедневным шагом 20–30 минут.', is_active = 1, priority = 140, meta_json = '{}'
WHERE key = 'natal.house.9.ruler.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.9.ruler.any', 'purpose_path', 'ru-RU', 'Управитель 9 дома — ключ к смыслу, мировоззрению и траектории роста: через что ты расширяешь горизонты и находишь направление. Он показывает, что делает обучение/путешествия/идею продуктивными, а что уводит в теорию без шага в реальность. Практика: выбери 1 «линию роста» на 14 дней (курс/чтение/проект/наставник) и закрепи её ежедневным шагом 20–30 минут.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.9.ruler.any' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.planet.mercury' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.planet.mercury', 'purpose_path', 'ru-RU', 'Меркурий в 10 доме усиливает видимость этой функции в карьере: люди считывают тебя через коммуникации, анализ, тексты, переговоры. Сильная сторона — проще получать признание за результаты по этой теме. Риск — перегружаться ожиданиями или застревать в роли. Практика: выбери 1 стандарт качества/границ (что делаю всегда, а что не беру) и закрепи его как правило.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.planet.mercury' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
...
WHERE key = 'natal.house.10.planet.sun' AND locale = 'ru-RU' AND topic_category = 'purpose_path';

INSERT INTO knowledge_items (key, topic_category, locale, text, priority, created_at, is_active, meta_json)
SELECT 'natal.house.10.planet.sun', 'purpose_path', 'ru-RU', 'Солнце в 10 доме усиливает видимость этой функции в карьере: люди считывают тебя через лидерство, видимость, роль и ответственность. Сильная сторона — проще получать признание за результаты по этой теме. Риск — перегружаться ожиданиями или застревать в роли. Практика: выбери 1 стандарт качества/границ (что делаю всегда, а что не беру) и закрепи его как правило.', 140, CURRENT_TIMESTAMP, 1, '{}'
WHERE NOT EXISTS (
  SELECT 1 FROM knowledge_items
  WHERE key = 'natal.house.10.planet.sun' AND locale = 'ru-RU' AND topic_category = 'purpose_path'
);
