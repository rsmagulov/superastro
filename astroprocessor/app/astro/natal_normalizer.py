...
HOUSE_RE = re.compile(
    r"^(First|Second|Third|Fourth|Fifth|Sixth|Seventh|Eighth|Ninth|Tenth|Eleventh|Twelfth)_House$",
    re.I,
)
HOUSE_NUM = {
    "first": 1,
...
def normalize_for_keybuilder(
    natal_data_raw: Dict[str, Any], *, unknown_time: bool
) -> Dict[str, Any]:
    """
